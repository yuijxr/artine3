...
<head>
    ...
    <style>
        ...
        .face-btn.active,
        .bodyshape-btn.active,
        .pose-btn.active {
            border-color: #1976d2;
            box-shadow: 0 0 0 3px rgba(25, 118, 210, 0.06);
        }
    </style>
...
<body> 
        ...
        <div class="profile-section">
                    ...
                    <div>
                        ...
                        <form id="account-form">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" id="acct-name" value="<?php echo htmlspecialchars(
                        $user["first_name"] . " " . $user["last_name"],
                    ); ?>">
                            </div>
                            <div class="form-row">
                                <label style="width:120px">Phone</label>
                                <input type="text" id="acct-phone" value="<?php echo htmlspecialchars(
                        $user["phone"] ?? "",
                    ); ?>">
                            </div>
                            <div class="form-row">
            ...
            <div class="tab-panel orders-panel" style="display:none;">
                ...
                if ($uid > 0) {
                    ...
                    foreach ($orders as $ord) {
                        ...
                        $thumb_path = $thumb
                            ? "assets/img/" . $folder . $thumb
                            : "assets/img/thumbnails/noimg.png";
                        ...
                        if ($statusLower === "pending") {
                            ...
                            if (!empty($ord["created_at"])) {
                                ...
                                if ($d) {
                                    $start = clone $d;
                                    date_modify($start, "+3 days");
                                    $end = clone $d;
                                    date_modify($end, "+5 days");
                                    $dateInfoHtml =
                                        '<p class="order-arrival">Arrives on ' .
                                        date_format($start, "M j") .
                                        "-" .
                                        date_format($end, "j") .
                                        "</p>";
                                }
                            ...
                            $raw =
                                ...
                                ($ord["created_at"] ?? null);
                            if ($raw) {
                                $d2 = date_create_from_format(
                                    "Y-m-d H:i:s",
                                    $raw,
                                );
                                if ($d2) {
                                    $dateInfoHtml =
                                        '<p class="order-arrival">' .
                                        ucfirst($statusLower) .
                                        " on " .
                                        date_format($d2, "M j, Y") .
                                        "</p>";
                                }
                            }
                        }
                        ...
                        foreach ($items as $it) {
                            ...
                            if (!$itthumb && !empty($it["image_url"])) {
                                $itthumb = $it["image_url"];
                            }
                            $icat = strtolower($it["category_name"] ?? "");
                            $ifolder = "";
                            if (strpos($icat, "shirt") !== false) {
                                $ifolder = "shirts/";
                            } elseif (strpos($icat, "cap") !== false) {
                                $ifolder = "caps/";
                            } elseif (strpos($icat, "perfume") !== false) {
                                $ifolder = "perfumes/";
                            }
                            $itthumb_path = $itthumb
                                ? "assets/img/" . $ifolder . $itthumb
                                : "assets/img/thumbnails/noimg.png";
            ...
            ?> <div id="orders-filter" class="orders-filter-tabs" role="tablist" aria-label="Order filters">
                        ...
                        $counts["pending"],
                                ...
                                <button class="orders-filter-btn" data-value="completed" role="tab">Completed (<?php echo intval(
                        $counts["completed"],
                    ); ?>)</button>
                    ...
                    <div id="orders-list" class="orders-list" data-hydrated="true"><?php echo $orders_html ?:
                    "<div>No orders yet.</div>"; ?></div>
    ...
    </div> <?php include "includes/footer.php"; ?> <script src="assets/js/account-tabs.js"></script>
