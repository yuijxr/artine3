...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    .then(list => {
        ...
        items.forEach(p => {
            ...
            const imgSrc = (window.AppUtils && window.AppUtils.resolveImagePath) ? window.AppUtils.resolveImagePath(p.image_url || p.image, p.category_name) : (p.image_url || p.image || 'assets/img/no-image.png');
    ...
    addBtn.addEventListener('click', async ()=>{
        ...
        const imagePath = (window.AppUtils && window.AppUtils.resolveImagePath) ? window.AppUtils.resolveImagePath(PRODUCT.image_url || PRODUCT.image || 'no-image.png', PRODUCT.category_name) : (PRODUCT.image_url || PRODUCT.image || 'assets/img/no-image.png');
